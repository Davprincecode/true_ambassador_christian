...
<h1>
   FILL THE FORM FOR DONATION
</h1>


<form action="../flutterwave/payment.php" method="post" class="contact-form">
...
<input type="number" name="amount" id="" class="contact-text" placeholder="Amount To Donate">
